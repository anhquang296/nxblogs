...
<ExcalidrawDiagram src="/sqs-overview.excalidraw" alt="Amazon SQS Overview — Producers, Queue, Consumers" />
...
<ExcalidrawDiagram
  ...
  alt="SQS Standard Queue — How Things Appear vs How Things Actually Are"
/>
...
<ExcalidrawDiagram src="/sqs-message-lifecycle.excalidraw" alt="SQS Message Lifecycle" />
...
<ExcalidrawDiagram
  ...
  alt="Dead Letter Queue Flow — Failed messages move to DLQ after maxReceiveCount, triggering CloudWatch Alarm for admin monitoring"
/>
...
<ExcalidrawDiagram src="/sqs-asg-scaling.excalidraw" alt="SQS with Auto Scaling Group — Queue-based Scaling" />
...
<ExcalidrawDiagram
  ...
  alt="SQS as Buffer for Database Writes — Decoupling Pattern"
/>
...
<ExcalidrawDiagram src="/sqs-sns-fan-out.excalidraw" alt="SNS + SQS Fan-Out Pattern — Buying Service sends one message to SNS Topic, fans out to multiple SQS queues" />
...
<ExcalidrawDiagram src="/sqs-s3-fan-out.excalidraw" alt="S3 Events Fan-Out — S3 sends event to SNS Topic, fans out to multiple SQS queues and Lambda" />
