...
description: 'Complete guide to deploying a Shopify App — understanding the split between physical deployment (cloud hosting) and logical app registration on Shopify.'
enableComment: true
---
...
- <Tooltip content="Shopify's official command-line tool for scaffolding, developing, and deploying apps">Shopify CLI</Tooltip> — `@shopify/cli` installed
...
- <Tooltip content="basic permissions like `read_products`, `write_products`, `read_orders`. You can use these immediately without approval">Standard scopes</Tooltip>
- <Tooltip content="permissions related to sensitive data or high-impact actions (creating orders, accessing all customer data, ...). Shopify requires you to explain your reasons and get approved before using them">Restricted scopes</Tooltip>
...
- <Tooltip content="also known as API Key">Client ID</Tooltip>
- <Tooltip content="also known as API Secret Key">Client Secret</Tooltip>
...
- <Tooltip content="HTTP callbacks Shopify sends to your URL when an event occurs (new order, product updated, ...)">Webhooks</Tooltip> are received (if the app registered any) — check logs on the cloud
