...
<ExcalidrawDiagram src="/lex-connect-appointment-flow.excalidraw" alt="Phone appointment-booking flow from Connect to Lex, Lambda then written into the CRM" />
...
<ExcalidrawDiagram src="/comprehend-medical-flow.excalidraw" alt="Three ingestion paths from S3, Kinesis Data Firehose and Transcribe into Comprehend Medical" />
