...
<ExcalidrawDiagram
  ...
  alt="Phone appointment-booking flow from Connect to Lex, Lambda then written into the CRM"
/>
...
<ExcalidrawDiagram
  ...
  alt="Three ingestion paths from S3, Kinesis Data Firehose and Transcribe into Comprehend Medical"
/>
