...
description: 'A detailed comparison of NAT Instance and NAT Gateway — how NAT Instance works under the hood, why Source/Destination Check must be disabled, and a comparison table to help you pick the right one.'
enableComment: true
---
