...
<ExcalidrawDiagram src="/aurora-cluster-endpoints.excalidraw" alt="Writer endpoint points to the primary, reader endpoint load-balances across replicas" />
...
<ExcalidrawDiagram src="/aurora-auto-scale.excalidraw" alt="Auto scaling adds replicas when CPU is high, all sharing the same shared storage" />
...
<ExcalidrawDiagram src="/aurora-custom-endpoint.excalidraw" alt="Custom endpoint groups powerful replicas dedicated to heavy queries" />
