...
![Sorted Set Overview](/sorted-set-overview.svg)
...
![Hash Table in Sorted Set](/sorted-set-hash-table.svg)
...
![Listpack memory layout](/sorted-set-listpack.svg)
...
![Encoding decision flowchart](/sorted-set-encoding-decision.svg)
...
![Dual structure routing table](/sorted-set-dual-structure.svg)
