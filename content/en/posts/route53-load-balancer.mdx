...
<ExcalidrawDiagram src="/route53-dns-vs-alb-layer.excalidraw" alt="Route 53 vs ALB: Which Layer Do They Operate At?" />
...
<ExcalidrawDiagram src="/route53-weighted-routing.excalidraw" alt="Weighted Routing: Split Traffic by Ratio" />
...
<ExcalidrawDiagram src="/route53-failover-routing.excalidraw" alt="Failover Routing: Automatic Failover During Incidents" />
...
<ExcalidrawDiagram src="/route53-bluegreen-canary.excalidraw" alt="Blue/Green + Canary: Transition Roadmap" />
...
<ExcalidrawDiagram src="/route53-alb-nlb-decision-tree.excalidraw" alt="Which Load Balancer to Choose?" />
...
<ExcalidrawDiagram src="/route53-combo-architecture.excalidraw" alt="Combined Architecture: Route 53 + ALB" />
