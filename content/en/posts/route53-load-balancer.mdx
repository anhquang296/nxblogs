...
![Route 53 vs ALB: Which Layer Do They Operate At?](/route53-dns-vs-alb-layer.svg)
...
![Weighted Routing: Split Traffic by Ratio](/route53-weighted-routing.svg)
...
![Failover Routing: Automatic Failover During Incidents](/route53-failover-routing.svg)
...
![Blue/Green + Canary: Transition Roadmap](/route53-bluegreen-canary.svg)
...
![Which Load Balancer to Choose?](/route53-alb-nlb-decision-tree.svg)
...
![Combined Architecture: Route 53 + ALB](/route53-combo-architecture.svg)
