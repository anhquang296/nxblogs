...
<ExcalidrawDiagram
  ...
  alt="Two layers of defense, stateless NACL at subnet level and stateful Security Group at instance level"
/>
...
<ExcalidrawDiagram
  ...
  alt="Client sends request from ephemeral port 50105 to server port 443, server responds to port 50105"
/>
