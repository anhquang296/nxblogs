...
<ExcalidrawDiagram
  ...
  alt="PostgreSQL architecture: from client down to pages on disk"
/>
...
<ExcalidrawDiagram src="/database-page.excalidraw" alt="A tuple is a data row, an 8KB page is its container on disk" />
...
<ExcalidrawDiagram src="/database-dead-tuple.excalidraw" alt="DELETE and UPDATE leave dead tuples behind under MVCC" />
...
<ExcalidrawDiagram src="/database-fragmentation.excalidraw" alt="Fragmentation: pages with few live tuples after VACUUM still cost much I/O" />
