...
<ExcalidrawDiagram
  ...
  alt="Cluster overview with master, data, ingest, coordinating nodes plus primary and replica shards"
/>
...
<ExcalidrawDiagram
  ...
  alt="3 primaries and 3 replicas across 3 data nodes, primary and replica never on the same node"
/>
...
<ExcalidrawDiagram
  ...
  alt="The _id hash modulo the shard count decides which shard a document lands on"
/>
...
<ExcalidrawDiagram
  ...
  alt="Allocation decider pipeline runs in sequence, a single NO blocks a shard's placement"
/>
...
<ExcalidrawDiagram
  ...
  alt="A new node joining makes the cluster rebalance 12 shards evenly across 4 nodes instead of 3"
/>
...
<ExcalidrawDiagram
  ...
  alt="Master election on a 5-node voting configuration, reaching quorum 3 to elect a new master"
/>
...
<ExcalidrawDiagram
  ...
  alt="Only a partition with quorum can elect a master, the minority half is blocked to avoid split-brain"
/>
