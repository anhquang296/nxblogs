...
<ExcalidrawDiagram src="/public-internet-vn-to-us-path.excalidraw" alt="Public internet path from Vietnam to a US server — many hops through ISPs and peering points" />
...
<ExcalidrawDiagram src="/aws-backbone-vn-to-us-path.excalidraw" alt="AWS Backbone Network path from Vietnam to us-east-1 — few hops, deterministic route" />
