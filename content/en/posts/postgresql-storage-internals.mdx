...
<ExcalidrawDiagram
  ...
  alt="PostgreSQL process and memory architecture, storage sits in the bottom-right"
/>

<ExcalidrawDiagram
  src="/postgresql-storage-internals-overview.excalidraw"
  alt="Read path from backend through the Shared Buffer Manager down to the heap file on disk"
/>
...
<ExcalidrawDiagram
  ...
  alt="PGDATA directory holding a table's files under base and the database OID"
/>
...
<ExcalidrawDiagram
  ...
  alt="The three forks main, _fsm, _vm of a relation and segment files past 1 GB"
/>
...
<ExcalidrawDiagram
  ...
  alt="An 8 KB heap page with line pointers growing down and tuples growing up"
/>
...
<ExcalidrawDiagram
  ...
  alt="HeapTupleHeader fields with null bitmap and user data inside a tuple"
/>
...
<ExcalidrawDiagram
  ...
  alt="Three-layer buffer table, descriptor array and buffer pool looking up a page via BufferTag"
/>
