...
The packet from client `1.2.3.4` with destination `52.10.10.10` (ALB's public IP) has arrived at the AWS edge network. The first component it encounters is the **Internet Gateway** (IGW — the gateway connecting VPC to the internet).
