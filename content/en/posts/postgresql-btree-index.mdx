...
<ExcalidrawDiagram
  ...
  alt="B-tree structure: root and internal nodes route, leaf nodes hold key and ctid"
/>
...
<ExcalidrawDiagram
  ...
  alt="Leaf node resolves a row via ctid: block number loads heap page, offset indexes line pointer array to tuple"
/>
...
<ExcalidrawDiagram
  ...
  alt="Logarithmic scalability: row count grows exponentially while B-tree depth reaches only about five levels"
/>
...
<ExcalidrawDiagram
  ...
  alt="Correlation comparison: high clusters keys on few heap pages, low scatters them causing random reads"
/>
