...
<ExcalidrawDiagram
  ...
  alt="Kafka architecture overview from producer through broker to consumer group"
/>
...
<ExcalidrawDiagram src="/kafka-data-flow-overview.excalidraw" alt="Data flow in Kafka through topic, partition and consumer group" />
...
<ExcalidrawDiagram src="/kafka-broker-storage.excalidraw" alt="Broker storage structure with segments and log, index, timeindex files" />
...
<ExcalidrawDiagram src="/kafka-zookeeper-vs-kraft.excalidraw" alt="ZooKeeper vs KRaft architecture for cluster metadata management" />
...
<ExcalidrawDiagram src="/kafka-partition-consumer-groups.excalidraw" alt="Multiple consumer groups reading the same partition independently with their own offsets" />
...
<ExcalidrawDiagram src="/kafka-replication.excalidraw" alt="Replication between leader and follower replicas and the role of ISR under acks" />
...
<ExcalidrawDiagram src="/kafka-zero-copy.excalidraw" alt="Traditional data transfer compared with zero-copy via sendfile" />
