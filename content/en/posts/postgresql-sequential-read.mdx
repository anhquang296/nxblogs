...
<ExcalidrawDiagram
  ...
  alt="The four-layer sequential read stack from query executor down to storage"
/>
...
![Physical anatomy of an HDD with platter, track, sector, actuator arm and read/write head](/hdd-disk.svg)
...
<ExcalidrawDiagram
  ...
  alt="Comparing sequential read of adjacent blocks with random read jumping around"
/>
...
<ExcalidrawDiagram
  ...
  alt="The three independent numbers of read(): bytes requested, bytes hitting disk and the physical block unit"
/>
...
<ExcalidrawDiagram
  ...
  alt="Read-ahead window lifecycle with prefetch and a readahead marker launching the next batch"
/>
...
<ExcalidrawDiagram
  ...
  alt="Heap file pages contiguous in logic but scattered across extents on the platter"
/>
