...
![Asynchronous Replication](/rds-async-replication.svg)
...
![Multi-AZ Synchronous Replication](/rds-multi-az-sync.svg)
...
![Write Latency: Single AZ vs Multi-AZ](/rds-write-latency.svg)
