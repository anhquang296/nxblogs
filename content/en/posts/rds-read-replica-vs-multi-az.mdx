...
<ExcalidrawDiagram src="/rds-async-replication.excalidraw" alt="Asynchronous replication: the primary returns OK immediately, without waiting for the replica to confirm" />
...
<ExcalidrawDiagram src="/rds-multi-az-sync.excalidraw" alt="Multi-AZ with a primary in AZ-A replicating synchronously to a standby in AZ-B" />
...
<ExcalidrawDiagram src="/rds-write-latency.excalidraw" alt="Write latency of Single-AZ versus Multi-AZ across the synchronous round-trip to the standby" />
