...
<ExcalidrawDiagram src="/connection-pool-tcp-handshake.excalidraw" alt="TCP 3-Way Handshake" />
...
<ExcalidrawDiagram src="/connection-pool-tcp-close.excalidraw" alt="TCP 4-Way Connection Close" />
...
<ExcalidrawDiagram src="/connection-pool-init-flow.excalidraw" alt="Connection Pool: Initialization & Usage" />
...
<ExcalidrawDiagram src="/connection-pool-local-problem.excalidraw" alt="The N Instances x Local Pool Problem" />
...
<ExcalidrawDiagram src="/connection-pool-rds-proxy.excalidraw" alt="RDS Proxy: Centralized Connection Pool" />
