...
<ExcalidrawDiagram src="/kinesis-firehose-overview.excalidraw" alt="Overview from producer through Kinesis shards to the Firehose pipeline and destination" />
...
<ExcalidrawDiagram src="/kinesis-shard-limits.excalidraw" alt="Fixed limits per shard and record routing via partition key" />
...
<ExcalidrawDiagram src="/firehose-pipeline.excalidraw" alt="Firehose pipeline from source through Lambda transform, format conversion, buffer to destination" />
