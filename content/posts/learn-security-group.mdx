...
1. **Hoạt động ở Instance Level:** SG được gắn trực tiếp vào card mạng (ENI) của instance, không phải ở cấp độ Subnet. Điều này tạo ra sự linh hoạt tối đa cho từng máy chủ riêng lẻ.
