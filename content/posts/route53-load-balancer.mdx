...
Trong [bài viết về DNS](/posts/how-dns-works-under-the-hood), chúng ta đã thấy DNS hoạt động như "cuốn danh bạ" — gõ tên miền, trả về IP. Nhưng nếu bước "trả về IP" đó **không cố định**, mà thay đổi tùy theo trọng số, vị trí địa lý, hay tình trạng sức khỏe của server thì sao? Lúc đó, DNS không còn là danh bạ nữa — nó trở thành một **bộ cân bằng tải**.
...
![Route 53 vs ALB: Hoạt Động Ở Tầng Nào?](/route53-dns-vs-alb-layer.svg)
...
![Weighted Routing: Chia Traffic Theo Tỷ Lệ](/route53-weighted-routing.svg)
...
![Failover Routing: Tự Động Chuyển Đổi Khi Sự Cố](/route53-failover-routing.svg)
...
![Blue/Green + Canary: Lộ Trình Chuyển Đổi](/route53-bluegreen-canary.svg)
...
![Chọn Load Balancer Nào?](/route53-alb-nlb-decision-tree.svg)
...
![Kiến Trúc Kết Hợp: Route 53 + ALB](/route53-combo-architecture.svg)
