...
![ALB: Hai Lớp Quyết Định](/alb-two-decision-layers.svg)
...
![Round Robin: Xoay Vòng](/alb-round-robin.svg)
...
![Least Outstanding Requests (LOR)](/alb-lor.svg)
...
![Weighted Random + Anomaly Mitigation](/alb-weighted-random.svg)
