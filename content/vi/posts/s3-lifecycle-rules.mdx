...
<ExcalidrawDiagram src="/s3-storage-class-transitions.excalidraw" alt="Object chỉ transition một chiều xuống các storage class rẻ hơn" />
...
<ExcalidrawDiagram src="/s3-lifecycle-pipeline.excalidraw" alt="Pipeline analytics từ Kinesis qua Glue đến Athena với lifecycle theo từng loại dữ liệu" />
