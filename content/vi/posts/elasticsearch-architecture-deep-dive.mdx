...
<ExcalidrawDiagram
  ...
  alt="Tổng quan cluster với master, data, ingest, coordinating node cùng primary và replica shard"
/>
...
<ExcalidrawDiagram
  ...
  alt="3 primary và 3 replica trải trên 3 data node, primary và replica không bao giờ cùng node"
/>
...
<ExcalidrawDiagram
  ...
  alt="Hash của _id chia lấy dư số shard quyết định document vào shard nào"
/>
...
<ExcalidrawDiagram
  ...
  alt="Pipeline allocation decider chạy tuần tự, chỉ một NO là chặn placement của shard"
/>
...
<ExcalidrawDiagram
  ...
  alt="Node mới join khiến cluster rebalance 12 shard đều ra 4 node thay vì 3"
/>
...
<ExcalidrawDiagram
  ...
  alt="Master election trên voting configuration 5 node, đạt quorum 3 để elect master mới"
/>
...
<ExcalidrawDiagram
  ...
  alt="Partition đủ quorum mới elect được master, nửa thiểu số bị chặn để tránh split-brain"
/>
