...
date: '2026-01-14'
tags: ['Database']
description: 'Giải quyết vấn đề replication lag — Read-Your-Writes consistency, session sticky routing, và giải pháp thực tế cho hệ thống database phân tán.'
enableComment: true
---

<ExcalidrawDiagram src="/read-your-write-consistency.excalidraw" alt="Replication lag khiến lần đọc sau khi ghi trúng replica chưa cập nhật" />
...
Bitbucket đã giải quyết vấn đề này một cách rất thông minh thông qua việc theo dõi <Tooltip content="Log Sequence Number — số thứ tự định danh duy nhất cho mỗi thay đổi trong write-ahead log của database">LSN</Tooltip> hoặc **Timestamp**.
...
Thay vì tin tưởng hoàn toàn vào DB, ta ghi dữ liệu mới vào Redis với <Tooltip content="Time To Live — thời gian sống của một entry trong cache trước khi tự động bị xóa">TTL</Tooltip> ngắn (bằng hoặc lớn hơn một chút so với Max Replication Lag).
