...
date: '2025-05-02'
tags: ['Devops']
description: 'Hướng dẫn tự động hóa SSL wildcard miễn phí — cấp phát, cài đặt, và auto-renew bằng acme.sh với Namecheap DNS API.'
enableComment: true
---
...
Để sử dụng phương thức <Tooltip content="Phương thức xác thực domain qua bản ghi TXT trên DNS, bắt buộc cho chứng chỉ wildcard">DNS-01 Challenge</Tooltip> (bắt buộc đối với Wildcard SSL), bạn cần:
...
Chạy câu lệnh sau để bắt đầu quá trình xác thực và cấp bằng. Ở đây mình dùng Let's Encrypt làm <Tooltip content="Certificate Authority — tổ chức phát hành và bảo chứng chứng chỉ SSL/TLS">CA</Tooltip>.
