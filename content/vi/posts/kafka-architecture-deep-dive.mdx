...
<ExcalidrawDiagram
  ...
  alt="Tổng quan kiến trúc Kafka từ producer qua broker đến consumer group"
/>
...
<ExcalidrawDiagram src="/kafka-data-flow-overview.excalidraw" alt="Luồng dữ liệu trong Kafka qua topic, partition và consumer group" />
...
<ExcalidrawDiagram src="/kafka-broker-storage.excalidraw" alt="Cấu trúc lưu trữ trên broker với segment và file log, index, timeindex" />
...
<ExcalidrawDiagram src="/kafka-zookeeper-vs-kraft.excalidraw" alt="So sánh kiến trúc ZooKeeper và KRaft trong quản lý metadata cluster" />
...
<ExcalidrawDiagram src="/kafka-partition-consumer-groups.excalidraw" alt="Nhiều consumer group đọc độc lập cùng partition với offset riêng" />
...
<ExcalidrawDiagram src="/kafka-replication.excalidraw" alt="Replication giữa leader và follower replica cùng vai trò của ISR theo acks" />
...
<ExcalidrawDiagram src="/kafka-zero-copy.excalidraw" alt="So sánh truyền dữ liệu truyền thống với zero-copy qua sendfile" />
