...
- **Manual commit**: Consumer commit sau khi xử lý xong. An toàn hơn nhưng nếu crash sau xử lý nhưng trước commit → message bị xử lý lại (duplicate). Đây là **at-least-once delivery** — chiến lược phổ biến nhất trong production.
...
> **Consumer rebalance protocol** là cơ chế phân bổ lại partition cho các consumer trong cùng consumer group một cách cân bằng, được trigger bởi **Group coordinator**.
