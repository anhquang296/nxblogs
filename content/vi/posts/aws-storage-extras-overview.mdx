...
- **Hai chiều và đa điểm:** chuyển dữ liệu qua giữa on-premises và AWS, giữa các regions/services trong AWS. Phía on-premises, bạn cài một DataSync agent (một máy ảo) để đọc dữ liệu qua <Tooltip content="Network File System — giao thức chia sẻ file phổ biến trên Linux/Unix">NFS</Tooltip> hoặc <Tooltip content="Server Message Block — giao thức chia sẻ file của Windows">SMB</Tooltip>.
