...
<ExcalidrawDiagram src="/aurora-cluster-endpoints.excalidraw" alt="Writer endpoint trỏ vào primary, reader endpoint load-balance giữa các replica" />
...
<ExcalidrawDiagram src="/aurora-auto-scale.excalidraw" alt="Auto scaling thêm replica khi CPU cao, tất cả dùng chung shared storage" />
...
<ExcalidrawDiagram src="/aurora-custom-endpoint.excalidraw" alt="Custom endpoint gom nhóm replica mạnh riêng cho heavy queries" />
