...
<ExcalidrawDiagram src="/kinesis-firehose-overview.excalidraw" alt="Tổng quan từ producer qua shard của Kinesis đến pipeline Firehose và destination" />
...
<ExcalidrawDiagram src="/kinesis-shard-limits.excalidraw" alt="Limit cố định mỗi shard và định tuyến record qua partition key" />
...
<ExcalidrawDiagram src="/firehose-pipeline.excalidraw" alt="Pipeline Firehose từ source qua Lambda transform, format conversion, buffer đến destination" />
