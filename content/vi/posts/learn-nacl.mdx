...
**NACL (Network Access Control List)** là một tường lửa ảo (virtual firewall) hoạt động ở cấp **subnet**. Nếu coi [VPC](/vi/posts/vpc-overview) là một khu đô thị và subnet là các khu phố, thì NACL chính là **hàng rào** bao quanh mỗi khu phố — kiểm soát ai được phép đi vào (Inbound) và ai được phép đi ra (Outbound).
