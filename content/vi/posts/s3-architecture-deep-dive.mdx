...
![Cách S3 lưu object vào bucket và phân quyền truy cập](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*0KjfelRYbTV2LoZhkD6isQ.png)
...
![Một object gồm file dữ liệu kèm metadata mô tả](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*MQUIEhyIFlB4uHOjBi-Jhg.png)
...
![So sánh cấu trúc phẳng của general-purpose bucket với cấu trúc phân cấp của directory bucket](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*DQbI6vRSRaj458et)
...
![Thêm dữ liệu nối tiếp vào object trong S3 Express One Zone directory bucket](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*NtIylAWLWvmdNBa-8lSQmA.png)
...
![Cấu trúc table bucket gom các table theo namespace](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*1Pxk8qkdT6RbyK78ODrkLQ.png)
...
![Bảng so sánh đặc điểm các loại S3 bucket, phần một](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*gKUqpBj7LqQG4-IKrksykA.png)![Bảng so sánh đặc điểm các loại S3 bucket, phần hai](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*bmxIlSku5GEQFr7qRmQgIA.png)
...
![Cách các object được lưu trữ bên trong S3 bucket](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ODj1rN_tk4BnbRf2jWx54w.png)
...
![S3 Metadata tự thu thập metadata vào bảng Iceberg để truy vấn](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Xl6ikFV4MTZhZ8G4GO0FCA.png)
...
![Luồng upload object lên S3 kèm mã hóa SSE-S3 mặc định](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*jFM43KUFispaC_egnt-BRg.png)
...
![Object lớn được chia thành nhiều part để upload độc lập](https://miro.medium.com/v2/resize:fit:682/format:webp/0*inpogPsFOg_iSteO.png)
...
![Quy trình ba bước của multipart upload qua một ví dụ cụ thể](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*eyRqo66J9fRQP9yefUZu5A.png)
...
![Mỗi part trả về ETag riêng, ghép lại thành checksum của các checksum](https://miro.medium.com/v2/resize:fit:1080/format:webp/1*lBdDkQAmiP6ESbI_OvUtTQ.png)
...
![Hủy multipart upload để xóa các part đã upload dở](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*2IQVH_1DyX2Jl65pvxoevA.png)
...
![Hai multipart upload đồng thời, upload bắt đầu muộn hơn thành version hiện tại](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*X2inZpn7F8GT_NRYA9ZpZA.png)
...
![Conditional write bỏ qua multipart upload đang dở khiến Client 1 hoàn tất thất bại](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*tAIceiqWuL296TGq.png)
...
![Xóa đồng thời được ưu tiên, conditional write nhận lỗi 409 hoặc 404](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*X6MahaKMgrlQ5DdB.png)
...
![S3 tính checksum phía server và lưu cùng object metadata](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*LTuy_b1llv0TkKa3Gs2C9Q.png)
...
![Full object checksum tính trên toàn bộ nội dung từ part đầu đến part cuối](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*iqOOuLiieC5ACDTX0f3GVQ.png)
...
![Composite checksum gộp các checksum cấp part thành một giá trị duy nhất](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*xIokGg41ZbKOID4qEQJltg.png)
...
![Luồng dùng presigned URL để cấp quyền truy cập object có giới hạn thời gian](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*T6Srcyn2FJ6x_dFEhd-6Yw.png)
...
![Mỗi team dùng một access point riêng với policy giới hạn theo prefix](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*qmzr7ZsHPXxkTTrQrBhnLg.png)
...
![S3 Object Lambda gọi Lambda function để biến đổi dữ liệu khi trả về](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*hENBs2OzTgbxw0hR.png)
...
![S3 Batch Operations chạy một thao tác trên hàng loạt object theo manifest](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*4CzIFfdk_Dv1gZwu.png)
...
![S3 Inventory xuất file CSV làm manifest đầu vào cho S3 Batch Operations](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Y_9X7hnzihfiJd7gpc3bmA.png)
...
![Các tùy chọn mã hóa server-side và client-side trong S3](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*iDGgoGbFUOwv3vC7pZyadg.png)
...
![Luồng SSE-S3 dùng root key mã hóa data key cho từng object](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Ovxr9z7opYHoxiZ1OjLgMA.png)
...
![Luồng SSE-KMS dùng KMS key và envelope encryption thay cho root key](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*B8GN6q3DTlm-XmQJZC37Rg.png)
...
![S3 Bucket Key giảm số lần gọi AWS KMS cho object dùng SSE-KMS](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*cTE7K04OspO_CWKJ.png)
...
![Luồng SSE-C dùng encryption key do client cung cấp để mã hóa object](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*7XP26b0CQpmr4V-4WBFeSw.png)
...
![Client mã hóa dữ liệu cục bộ trước khi gửi object đã mã hóa lên S3](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*fkl3MDIth-E_avTiyUfaaQ.png)
...
![Replication rule tự động sao chép object bất đồng bộ sang bucket đích](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*9Fm6S5_-GntoFbGw_crg_w.png)
...
![Multi-Region Access Point định tuyến request đến bucket gần nhất qua AWS global network](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*CEUgCgJw_-LBzJcxgwXjCQ.png)
...
![Một bucket chưa bật versioning chỉ giữ một phiên bản object](https://miro.medium.com/v2/resize:fit:544/format:webp/0*SVfMy3Xh-m9dl2JB.png)![Bucket bật versioning giữ nhiều phiên bản với version ID riêng](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*RddlCFZXlXuamlyDuGelmw.png)
...
![Xóa object chỉ chèn delete marker thay vì xóa vĩnh viễn](https://miro.medium.com/v2/resize:fit:674/format:webp/0*ze7yHmP7UuifGOs1.png)![Ghi đè object tạo thêm phiên bản mới và giữ lại phiên bản cũ](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*TKI7DijwgAgEJXrVvQ9M5Q.png)
...
![Object Lock dùng mô hình WORM với retention period và legal hold](https://miro.medium.com/v2/resize:fit:1248/format:webp/0*Hnmtf0LMU62dGEvh.jpg)
...
![Mỗi prefix được phân vùng để scale request rate song song](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*nsHGUp3a4LS0tKfvBMV20Q.png)
...
![Fetch song song nhiều byte-range từ cùng object để tăng throughput](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*s5BA--h_L8YB0pQbr_CBoA.png)
...
![Byte-range request chỉ lấy phần header đầu file thay vì toàn bộ object](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*37aC0Xur04qUgrGh8jU7nQ.png)
...
![Transfer Acceleration định tuyến dữ liệu qua edge location rồi về S3 qua đường tối ưu](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*mJTG_bWhmAX8cNVLRgtMfg.png)
...
![Mạng lưới edge location của CloudFront trải khắp toàn cầu](https://miro.medium.com/v2/format:webp/1*lHrgv1gFEXqNhtnpCVXH9A.png)
