...
<ExcalidrawDiagram src="/lex-connect-appointment-flow.excalidraw" alt="Luồng đặt lịch qua điện thoại từ Connect tới Lex, Lambda rồi ghi vào CRM" />
...
<ExcalidrawDiagram src="/comprehend-medical-flow.excalidraw" alt="Ba đường nạp dữ liệu từ S3, Kinesis Data Firehose và Transcribe vào Comprehend Medical" />
