...
CDN là một mạng máy chủ đặt rải toàn cầu, phục vụ nội dung từ điểm gần người dùng nhất. **CloudFront** là CDN của AWS: nó
cache nội dung tại các edge location nằm sát người dùng, nên một người dùng ở Hà Nội không phải gọi tận origin ở Singapore hay Mỹ cho mỗi request.
