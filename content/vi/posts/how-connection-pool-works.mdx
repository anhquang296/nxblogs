...
<ExcalidrawDiagram src="/connection-pool-init-flow.excalidraw" alt="Connection Pool: Khởi tạo & Sử dụng" />
...
<ExcalidrawDiagram src="/connection-pool-local-problem.excalidraw" alt="Vấn đề N Instances × Local Pool" />
