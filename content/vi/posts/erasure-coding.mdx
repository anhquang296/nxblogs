...
<ExcalidrawDiagram src="/erasure-coding-overview.excalidraw" alt="Cấu hình 4+2 chia dữ liệu thành 4 data shard và 2 parity shard" />
...
<ExcalidrawDiagram src="/erasure-coding-simple-parity.excalidraw" alt="Parity bằng phép cộng 4 data shard, lưu trên 5 server" />
...
<ExcalidrawDiagram src="/erasure-coding-reed-solomon.excalidraw" alt="Reed-Solomon coi data shard là hệ số đa thức, evaluate tại k+m điểm" />
...
<ExcalidrawDiagram src="/erasure-coding-encoding-matrix.excalidraw" alt="Encoding matrix với ma trận đơn vị ở trên và hệ số parity ở dưới" />
...
<ExcalidrawDiagram src="/erasure-coding-decoding.excalidraw" alt="Decoding bằng cách đảo ngược submatrix từ k shard còn sống" />
...
<ExcalidrawDiagram src="/erasure-coding-replication-vs-ec.excalidraw" alt="So sánh storage overhead giữa replication và erasure coding" />
