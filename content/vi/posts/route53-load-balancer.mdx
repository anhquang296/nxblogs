...
<ExcalidrawDiagram src="/route53-dns-vs-alb-layer.excalidraw" alt="Route 53 vs ALB: Hoạt Động Ở Tầng Nào?" />
...
<ExcalidrawDiagram src="/route53-weighted-routing.excalidraw" alt="Weighted Routing: Chia Traffic Theo Tỷ Lệ" />
...
<ExcalidrawDiagram src="/route53-failover-routing.excalidraw" alt="Failover Routing: Tự Động Chuyển Đổi Khi Sự Cố" />
...
<ExcalidrawDiagram src="/route53-bluegreen-canary.excalidraw" alt="Blue/Green + Canary: Lộ Trình Chuyển Đổi" />
...
<ExcalidrawDiagram src="/route53-alb-nlb-decision-tree.excalidraw" alt="Chọn Load Balancer Nào?" />
...
<ExcalidrawDiagram src="/route53-combo-architecture.excalidraw" alt="Kiến Trúc Kết Hợp: Route 53 + ALB" />
