...
description: 'EC2 cơ bản — cách instance chạy trên physical host, các instance types (compute/memory/storage optimized), và cách chọn đúng loại cho workload.'
enableComment: true
---
...
- <Tooltip content="Amazon Machine Image — khuôn mẫu chứa hệ điều hành và phần mềm cài sẵn, dùng để khởi tạo EC2 instance">AMI</Tooltip>: "Khuôn mẫu" chứa hệ điều hành (Linux, Windows) và các phần mềm cài sẵn.
...
- <Tooltip content="Elastic Block Store — dịch vụ lưu trữ block-level của AWS, gắn vào EC2 qua mạng và tồn tại độc lập với instance">EBS</Tooltip>: Hãy nghĩ về nó như một cái **Google Drive** hay một cái USB cắm qua mạng (Network Drive).
...
- **Sử dụng:**
  - Hệ thống <Tooltip content="Online Transaction Processing — xử lý giao dịch trực tuyến với nhiều thao tác đọc/ghi nhỏ, ưu tiên độ trễ thấp">OLTP</Tooltip>.
