...
<ExcalidrawDiagram src="/rds-async-replication.excalidraw" alt="Asynchronous replication: primary trả OK ngay, không chờ replica xác nhận" />
...
<ExcalidrawDiagram src="/rds-multi-az-sync.excalidraw" alt="Multi-AZ với primary ở AZ-A đồng bộ synchronous sang standby ở AZ-B" />
...
<ExcalidrawDiagram src="/rds-write-latency.excalidraw" alt="Write latency của Single-AZ so với Multi-AZ qua round-trip đồng bộ tới standby" />
