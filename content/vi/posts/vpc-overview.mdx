...
<ExcalidrawDiagram
  ...
  alt="Tổng quan kiến trúc VPC với 3 hành trình của packet bên trong"
/>
...
<ExcalidrawDiagram
  ...
  alt="Internet Gateway dịch NAT 1:1 từ public IP sang private IP của ALB"
/>
...
<ExcalidrawDiagram
  ...
  alt="Route table của public subnet và private subnet với default route khác nhau"
/>
...
<ExcalidrawDiagram src="/vpc-alb-routing-to-private-subnet.excalidraw" alt="ALB tạo connection mới forward request đến EC2 ở private subnet" />
...
<ExcalidrawDiagram
  ...
  alt="EC2 gọi S3 qua VPC Gateway Endpoint trên AWS backbone, không ra internet, không NAT"
/>
...
<ExcalidrawDiagram
  ...
  alt="EC2 ở private subnet gọi Stripe qua NAT Gateway và IGW, với hai lần NAT trên đường đi"
/>
