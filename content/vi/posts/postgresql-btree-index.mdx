...
<ExcalidrawDiagram
  ...
  alt="Cấu trúc B-tree: root và internal node định tuyến, leaf node giữ key và ctid"
/>
...
<ExcalidrawDiagram
  ...
  alt="Leaf node phân giải row qua ctid: block số nạp heap page, offset tra line pointer array tới tuple"
/>
...
<ExcalidrawDiagram
  ...
  alt="Khả năng mở rộng logarit: số row tăng theo cấp số nhân, độ sâu B-tree chỉ tới khoảng 5 tầng"
/>
...
<ExcalidrawDiagram
  ...
  alt="So sánh correlation: cao thì key gom trên ít heap page, thấp thì rải khắp gây random read"
/>
