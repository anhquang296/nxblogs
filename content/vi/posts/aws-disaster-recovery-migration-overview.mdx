...
**Hiệu năng nằm ở Agent.** Throughput (tốc độ truyền) của DataSync phụ thuộc rất nhiều vào tài nguyên bạn cấp cho Agent — phần mềm chạy ở phía on-premises, thường được triển khai trên một <Tooltip content="Phần mềm ảo hóa cho phép chạy nhiều máy ảo trên cùng một máy chủ vật lý, ví dụ VMware ESXi, Microsoft Hyper-V hay Linux KVM">hypervisor</Tooltip>. Agent thiếu tài nguyên thì việc truyền vẫn chậm dù đường mạng có rộng đến đâu. Ba thứ cần cấp đủ:
