...
<ExcalidrawDiagram
  ...
  alt="Hai cách user Account A ghi vào S3 bucket Account B: assume cross-account role hoặc qua bucket policy"
/>
...
<ExcalidrawDiagram
  ...
  alt="Logic đánh giá policy của IAM lần lượt qua sáu nhóm, một explicit Deny là từ chối ngay"
/>
...
<ExcalidrawDiagram
  ...
  alt="Group Developers được gán permission set FullAccess, tạo IAM role toàn quyền vào Dev Account B"
/>
