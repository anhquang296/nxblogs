...
<ExcalidrawDiagram
  ...
  alt="Kiến trúc PostgreSQL: từ client xuống page trên disk"
/>
...
<ExcalidrawDiagram src="/database-page.excalidraw" alt="Tuple là dòng dữ liệu, page 8KB là vật chứa trên disk" />
...
<ExcalidrawDiagram src="/database-dead-tuple.excalidraw" alt="DELETE và UPDATE để lại dead tuple theo cơ chế MVCC" />
...
<ExcalidrawDiagram src="/database-fragmentation.excalidraw" alt="Fragmentation: page rải rác ít live tuple sau khi VACUUM, vẫn tốn nhiều I/O" />
