...
date: '2024-12-03'
tags: ['Devops']
description: 'Hiểu CIDR notation cho phân bổ IP — subnet masks, prefix lengths, tính toán địa chỉ, và ví dụ thực tế cho network engineers.'
enableComment: true
---

# Tìm hiểu CIDR: Hướng dẫn toàn diện

![Banner chủ đề CIDR, phương pháp phân bổ IP và định tuyến không phân lớp](/cidr-text.png)

## CIDR là gì?

<Tooltip content="Classless Inter-Domain Routing — phương pháp định tuyến IP không phân lớp, dùng prefix dài bất kỳ để chia mạng linh hoạt thay cho hệ thống Class A/B/C cũ">CIDR</Tooltip> là một phương pháp cải tiến để phân bổ địa chỉ IP và định tuyến dữ liệu trên internet. Nó thay thế hệ thống cũ để giúp việc truyền thông trên internet hiệu quả hơn.
...
![Ký hiệu CIDR với prefix length cho biết số bit dành cho phần mạng](/what-is-cidr.webp)
