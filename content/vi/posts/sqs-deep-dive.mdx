...
<ExcalidrawDiagram src="/sqs-sns-fan-out.excalidraw" alt="SNS + SQS Fan-Out Pattern — Buying Service gửi một message đến SNS Topic, fan-out đến nhiều SQS queues" />
...
<ExcalidrawDiagram src="/sqs-s3-fan-out.excalidraw" alt="S3 Events Fan-Out — S3 gửi event đến SNS Topic, fan-out đến nhiều SQS queues và Lambda" />
