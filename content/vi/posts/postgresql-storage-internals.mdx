...
<ExcalidrawDiagram
  ...
  alt="Kiến trúc process và memory của PostgreSQL, storage nằm ở góc dưới-phải"
/>

<ExcalidrawDiagram
  src="/postgresql-storage-internals-overview.excalidraw"
  alt="Đường đi đọc dữ liệu từ backend qua Shared Buffer Manager xuống heap file trên disk"
/>
...
<ExcalidrawDiagram
  ...
  alt="Cấu trúc thư mục PGDATA chứa các file của một bảng dưới base và database OID"
/>
...
<ExcalidrawDiagram
  ...
  alt="Ba forks main, _fsm, _vm của một relation và các segment file khi vượt 1 GB"
/>
...
<ExcalidrawDiagram
  ...
  alt="Cấu trúc một heap page 8 KB với line pointer mọc xuống và tuple mọc lên"
/>
...
<ExcalidrawDiagram
  ...
  alt="Các field của HeapTupleHeader cùng null bitmap và user data trong một tuple"
/>
...
<ExcalidrawDiagram
  ...
  alt="Kiến trúc ba tầng buffer table, descriptor array và buffer pool tra cứu page qua BufferTag"
/>
