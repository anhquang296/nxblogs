...
description: 'Nắm vững 6 tùy chọn mua EC2 — On-Demand, Reserved, Savings Plans, Spot, Dedicated Hosts, Capacity Reservations — tiết kiệm đến 90% chi phí compute.'
enableComment: true
---

# AWS EC2 Instance Purchasing Options: Nghệ thuật trả giá

Khi bắt đầu với EC2, nhiều người thường chỉ biết đến <Tooltip content="Trả theo giây/giờ thực tế sử dụng, không cần cam kết, chi phí cao nhất">On-Demand Instances</Tooltip> - cách đơn giản nhất là "bật máy lên và trả tiền". Nhưng thực tế, AWS cung cấp đến **6 loại hình thức mua Instance** khác nhau, mỗi loại đều có ưu nhược điểm riêng và phù hợp với từng tình huống cụ thể.

Hiểu rõ các lựa chọn này không chỉ giúp bạn tiết kiệm chi phí đáng kể (có thể lên đến 90%) mà còn là kiến thức bắt buộc để vượt qua kỳ thi <Tooltip content="AWS Certified Solutions Architect Associate">SAA</Tooltip>.
...
* **Spot Instance Interruption:** AWS có thể thu hồi Instance bất cứ lúc nào nếu:
  * Có khách hàng On-Demand hoặc <Tooltip content="Cam kết sử dụng instance cụ thể trong 1-3 năm để nhận chiết khấu lên tới 72%">Reserved Instance</Tooltip> cần dùng tài nguyên đó.
...
* **Định nghĩa:** <Tooltip content="Tập hợp Spot Instances kết hợp tùy chọn với On-Demand, tự phân phối qua nhiều instance types và AZ để tối ưu chi phí">Spot Fleet</Tooltip> là một tập hợp (set) các Spot Instances, có thể kết hợp với On-Demand Instances (optional).
...
* **Đặc điểm quan trọng nhất:** Hỗ trợ các loại giấy phép phần mềm (License) tính theo core hoặc socket - <Tooltip content="Bring Your Own License">BYOL</Tooltip>.
